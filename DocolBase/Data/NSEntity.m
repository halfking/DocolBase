...
- (void)setPropValue:(NSString *)pName propType:(HCEPropertyType *)pt value:(id)value
{
    ...
    else
    {
        ...
        else if([pt isCMTime])
        {
            ...
            NSRange rangEnd = [sv rangeOfString:@"," options:NSCaseInsensitiveSearch range:rangTemp locale:nil];
...
//                rangEnd = [sv rangeOfRegex:@"," inRange:rangTemp];
                rangEnd = [sv rangeOfString:@"," options:NSCaseInsensitiveSearch range:rangTemp locale:nil];
            }
        ...
        else
        {
            ...
            else if([value isKindOfClass:[NSArray class]]==YES)
            {
                ...
                {
                    if(pt.IsObject && [value isKindOfClass:[NSObject class]])
                    {
                        [self setValue:value forKey:pName];
                    }
                    else
